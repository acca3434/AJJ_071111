class numberAnimation {
    constructor() {
      ...
      this.day = ("0" + (this.today.getDate() + 1)).slice(-2);
      this.goal = this.year + this.month + this.day;
      this.speedUp = null;
      this.second = [1, 2, 3, 4, 5, 100];
      // this.speedTag = document.querySelector('.number-animation-speed');
    ...
    againstSum(n) {
      ...
      console.log(_this.againstSum(_this.goal), "나머지는:", _this.goal - _this.sum(_this.againstSum(_this.goal)));
    }
    increaseAnimaition() {
      const _this = this;
